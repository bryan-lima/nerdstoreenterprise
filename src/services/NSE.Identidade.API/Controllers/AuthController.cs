...
namespace NSE.Identidade.API.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        private async Task<ResponseMessage> RegistrarCliente(UsuarioRegistro usuarioRegistro)
        {
            ...
            /* A porta abaixo, 5672, é a padrão do RabbitMQ e nesse caso poderia ser omitido, pois por debaixo dos panos, será utilizado essa mesmíssima porta (por ser default)
             * Caso a porta fosse diferente, obviamente que é necessário ser informado */

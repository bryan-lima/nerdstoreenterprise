...
namespace NSE.WebApp.MVC.Services
{
    ...
    public class AutenticacaoService : Service, IAutenticacaoService
    {
        ...
        public async Task RealizarLogin(UsuarioRespostaLogin resposta)
        {
            ...
            await _authenticationService.SignInAsync(_user.ObterHttpContext(), CookieAuthenticationDefaults.AuthenticationScheme, new ClaimsPrincipal(claimsIdentity), authProperties);
        }
